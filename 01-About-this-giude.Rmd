...
Here you will learn how to navigate through  __Tercen__ and use the software to work with your data. 

\

The Chapters are laid out as step-by-step instructions that cover the key areas of use. 
