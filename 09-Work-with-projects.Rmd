...
This section will familiarise you with the __Tercen__ project screens. 

You will learn the meanings of the icons, how to upload data, and view a Workflow.

\

## Navigating and commenting {-}

Icons perform administrative tasks and provide visual information about the status of your project.
...
`Locked`  - Shows that project has not been made public. Only the owner can view it.\
...
They are listed in a descending timeline.
...
Users with project __admin__ permissions can edit or delete comments.
...
The main commands that can be performed on a project.
...
These are the files that are attached to the project. 

They can be documents, data, or workflows.
...
For more detailed information on creating and modifying workflows see Chapter 10: Understanding Workflows.
...
Files created in different programs are attached using the `Import File` button.
