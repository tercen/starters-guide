...
Teams are an essential concept in __Tercen__. 
...
`Read Write`  - Can modify projects, such as adding operators to workflows\
...
__Next__... add a calculation app to your team library.