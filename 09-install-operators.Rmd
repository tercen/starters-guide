# Install operators
In this section you will install operators in the __Tercen cloud__ for your team to use.
...
You have now installed an operator that can be used by this team. The next section will show you how to upload data to the __Tercen cloud__
