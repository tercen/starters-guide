...
Libraries can be built from differant sources such as the public __Tercen app library__ or uploaded from private sources such as __GitHub__.

\

For a more in-depth discussion of apps, and their uses, please see the User Guide.
...
Access your personal home page 
...
If required, click on the `More` link to read detailed information on this app.
...
Next... understanding how projects work.