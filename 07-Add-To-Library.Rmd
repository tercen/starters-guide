...
Apps can be added to a teams Library from different sources.

One source is the public __Tercen app library__. 

Or you can add from private sources such as __GitHub__.

Our next Chapter... "Understanding Projects" will give more detail on how Apps are applied to make computations. 
