...
Each personal user, and each team, has access to a repository of apps called a Library.

Apps are the workhorses of a Project.

They perform the mathematical computations on the data you upload.

There are three different types of App.
...
Apps can be added to a team's Library from different sources.

One source is the public __Tercen app library__. 

Or you can add from private sources such as __GitHub__.

More detail on how Apps are applied is given in Chapter 8: Understanding Projects. 
...
To install an app to your Library. 

Select your personal home page 
