# Compute your data
In this section you will perform a computation by selecting an previously installed operator and running it on your data.
...
First we will select the operator of choice.
...
You have computed a PCA on the data. The next sections will cover viewing the results of the PCA. 