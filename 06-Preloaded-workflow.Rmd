...
In this section we will use the preloaded crabs data to show you the possibilities of data computation in the __Tercen cloud__.
Starting in the project homepage, you will see that the Tutorial workflow and crabs data is preloaded.
...
Thanks to the drag and drop way of working in the __Tercen cloud__ you can quickly and intuitively visualize the results of your data. 

Your data can be visualized in many ways using the __Tercen cloud__ and every visualization can provide different insights. Next we will visualize the crabs_longformat using a pair-wise plot. 
...
You now have an idea of the possibilities using the __Tercen cloud__. For more information about how to upload and work with your own data, continue reading the getting started guide. 
